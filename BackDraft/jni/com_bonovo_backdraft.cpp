...
#define LOG_TAG    "com_bonovo_backdraft"
...
static jboolean android_videoin_openSerial(JNIEnv *env, jobject thiz){
...
static void android_videoin_closeSerial(JNIEnv *env, jobject thiz){
	if(fdTtyS3 > 0){
		close(fdTtyS3);
		fdTtyS3 = -1;
	}
...
static jboolean android_videoin_switch(JNIEnv *env, jobject thiz, jboolean offOn) {
...
static const char *classPathName = "com/bonovo/backdraft/BackDraftActivity";

static JNINativeMethod sMethods[] = {
	{"jniOpenSerial","()Z", (void *)android_videoin_openSerial},
	{"jniVideoInSwitch", "(Z)Z", (void *)android_videoin_switch},
	{"jniCloseSerial", "()V", (void *)android_videoin_closeSerial},
};
